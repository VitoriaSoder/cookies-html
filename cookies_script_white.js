function insertCSS() {
  ...
  .cookie-banner {
      ...
      margin: auto;
      align-items: center;
      border-top: 3px solid var(--Color-1, #a19e9e);
      background: var(--Primary-2, #f5f5f5);
  ...
  .settings-button {
    ...
    border-radius: 4px;
    border: 2px solid var(--Color-1, #3941ff);
    color: var(--Color-4, #3941ff);
    font-weight: 400;
    padding: 7px 14px;
  ...
  .accept-button {
    border-radius: 4px;
    background: var(--Color-1, #3941ff);
    color: var(--Secondary-1, #fff);
    font-weight: 600;
    padding: 7px 15px;
    border: none;
    cursor: pointer;
  ...
  .preference-content {
    border: 2px solid var(--Secondary-2, #6E7191);
    padding: 15px 20px;
  }
